...
scripty-cli2 = require '../lib/azure-scripty-cli2.js'
...
scripty-cli2.exec = (cmd, callback) -> 
  calls++;
...
describe 'scripty-cli2', ->
  ...
  describe 'when calling invoke with a single command', ->
    it 'should invoke the completion callback', (done) ->
      ...
      scripty-cli2.invoke 'foo bar1', obj.complete
    ...
    it 'should return the result object', (done) ->
      ...
      scripty-cli2.invoke 'foo bar2', obj.complete      
    ...
    describe 'and an error occurs', ->
      it 'should return the error', (done) ->
        ...
        scripty-cli2.invoke 'foo bar3', obj.complete   
  ...
  describe 'when calling invoke with multiple commands', ->
    it 'should invoke the completion callback', (done) ->
      ...
      scripty-cli2.invoke cmds, obj.complete
  ...
  describe 'when calling invoke with multiple command objects', ->
    it 'should make the proper calls', (done) ->
      ...
      scripty-cli2.invoke cmds, ->
        #if it succeeds this worked as scripty-cli2.exec validates the exepcted cmd against the received cmd
        done()
